...
export default function About() {
  return (
    <div className="about-page">
      ...
      <p className="subtitle">AI Programmer (vocational training), Lexicon AB (Mar 2026 - Present)</p>
      <p>Focus on development of web applications and cloud services.</p>

      <p className="subtitle">Labor market activities + language courses (Jul 2024 - Mar 2026)</p>
      <p>Participated in various activities to improve employability and language skills.</p>

      <p className="subtitle">Master of Science in Engineering (Robotics), Mälardalen University (Sep 2019 - Jul 2024)</p>
